...
namespace Sharpshooter.Champions
{
    public static class Tristana
    {
        ...
        public static void Load()
        {
            ...
            SharpShooter.Menu.SubMenu("连招").AddItem(new MenuItem("comboUseQ", "使用 Q", true).SetValue(true));
            SharpShooter.Menu.SubMenu("连招").AddItem(new MenuItem("comboUseW", "使用 W", true).SetValue(false));
            SharpShooter.Menu.SubMenu("连招").AddItem(new MenuItem("comboUseE", "使用 E", true).SetValue(true));
            SharpShooter.Menu.SubMenu("连招").AddItem(new MenuItem("comboUseR", "使用 R", true).SetValue(true));

            SharpShooter.Menu.SubMenu("骚扰").AddItem(new MenuItem("harassUseE", "使用 E", true).SetValue(true));
            SharpShooter.Menu.SubMenu("骚扰").AddItem(new MenuItem("harassMana", "如果法力>%", true).SetValue(new Slider(50, 0, 100)));

            SharpShooter.Menu.SubMenu("Laneclear").AddItem(new MenuItem("laneclearUseQ", "使用 Q", true).SetValue(false));
            //SharpShooter.Menu.SubMenu("Laneclear").AddItem(new MenuItem("laneclearMana", "如果法力>%", true).SetValue(new Slider(50, 0, 100)));
            ...
            SharpShooter.Menu.SubMenu("杂项").AddItem(new MenuItem("antigapcloser", "Use Anti-Gapcloser", true).SetValue(true));
            SharpShooter.Menu.SubMenu("杂项").AddItem(new MenuItem("autointerrupt", "Use Auto-Interrupt", true).SetValue(true));
            SharpShooter.Menu.SubMenu("杂项").AddItem(new MenuItem("killsteal", "Use Killsteal (With R)", true).SetValue(true));

            SharpShooter.Menu.SubMenu("标示").AddItem(new MenuItem("drawingAA", "真实AA范围", true).SetValue(new Circle(true, Color.FromArgb(255, 178, 217))));
            SharpShooter.Menu.SubMenu("标示").AddItem(new MenuItem("drawingW", "W范围", true).SetValue(new Circle(true, Color.FromArgb(255, 178, 217))));

            SharpShooter.Menu.SubMenu("标示").AddItem(drawDamageMenu);
            SharpShooter.Menu.SubMenu("标示").AddItem(drawFill);
