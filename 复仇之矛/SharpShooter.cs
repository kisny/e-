...
namespace Sharpshooter
{
    internal static class SharpShooter
    {
        ...
        internal static void Load()
        {
            ...
            Menu = new Menu("蓝调-射手合集", "xcsoft_sharpshooter", true);
            ...
            Menu.AddSubMenu(new Menu(Player.ChampionName + ": 清线", "Laneclear"));
            Menu.AddSubMenu(new Menu(Player.ChampionName + ": 刷野", "Jungleclear"));
            Menu.AddSubMenu(new Menu(Player.ChampionName + ": 杂项", "Misc"));
            Menu.AddSubMenu(new Menu(Player.ChampionName + ": 标示", "Drawings"));
            ...
            Menu.SubMenu("Drawings").AddItem(new MenuItem("potxt", "公用选项"));

            Menu.SubMenu("Drawings").AddItem(new MenuItem("drawingTarget", "AA目标").SetValue(true));
            Menu.SubMenu("Drawings").AddItem(new MenuItem("drawMinionLastHit", "补兵").SetValue(new Circle(true, Color.GreenYellow)));
            Menu.SubMenu("Drawings").AddItem(new MenuItem("drawMinionNearKill", "快要死亡小兵").SetValue(new Circle(true, Color.Gray)));
